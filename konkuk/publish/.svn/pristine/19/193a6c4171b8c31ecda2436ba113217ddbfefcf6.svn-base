$(document).ready(function() {
	...
	//진로설정 및 취업역량강화 교과목 이수자 취업률 클릭 팝업
	$('.analysis08').find('tbody tr').on('click', function() {
		window.open('analysis08_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//현장실습 학점인정제 교과목 이수자 취업률 클릭 팝업
	$('.analysis09').find('tbody tr').on('click', function() {
		window.open('analysis09_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});
	...
	//취업자/미취업자 역량별 평점 통계 클릭 팝업
	$('.analysis11_1').find('tbody tr').on('click', function() {
		window.open('analysis11_1_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//남녀 취업자 역량별 평점 통계 클릭 팝업
	$('.analysis11_2').find('tbody tr').on('click', function() {
		window.open('analysis11_2_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//취업자/미취업자 비교과 유형 건수 통계 클릭 팝업
	$('.analysis12_1').find('tbody tr').on('click', function() {
		window.open('analysis12_1_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//취업자/미취업자 WE人학생역량인증자 건수 클릭 팝업
	$('.analysis12_2').find('tbody tr').on('click', function() {
		window.open('analysis12_2_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//취업자/미취업자 상담유형별 평균건수 통계 클릭 팝업
	$('.analysis13_1').find('tbody tr').on('click', function() {
		window.open('analysis13_1_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//위인전 진로정보와의 일치 건수 통계 클릭 팝업
	$('.analysis13_2').find('tbody tr').on('click', function() {
		window.open('analysis13_2_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//위인전 취업/진로 상담횟수별 취업률 비교 클릭 팝업
	$('.analysis13_3').find('tbody tr').on('click', function() {
		window.open('analysis13_3_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});
	...
	//최근 3년간 경쟁대학 취업률 비교 클릭 팝업
	$('.rival02_2').find('tbody tr').on('click', function() {
		window.open('rival02_2_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//최근 3년간 경쟁대학 계열별 취업률 비교 클릭 팝업
	$('.rival02_3').find('tbody tr').on('click', function() {
		window.open('rival02_3_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//기업구분별 단과대학 및 학과(전공)별 통계 클릭 팝업
	$('.company_classification01').find('tbody tr').on('click', function() {
		window.open('company_classification01_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//산업별 단과대학 및 학과(전공)별 통계 클릭 팝업
	$('.company_classification02').find('tbody tr').on('click', function() {
		window.open('company_classification02_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});

	//기업별 단과대학 및 학과(전공)별 통계 클릭 팝업
	$('.company_classification03').find('tbody tr').on('click', function() {
		window.open('company_classification03_popup.html', '_blank', 'width=1920px,height=1000px,scrollbars=yes');
		return false;
	});
	...
	//기업별 단과대학 및 학과(전공)별 통계 회사검색 클릭 이벤트, 취업통계조사 회사검색 클릭 이벤트
